        ...
        <div className="about-grid">
          <div className="about-content">
            ...
            <p className="about-description">
              20년 이상의 경험을 바탕으로 국내외 다양한 자동차 제조사에 고품질 부품을 공급하고 있습니다. 
              혁신적인 기술 개발과 엄격한 품질 관리를 통해 신뢰할 수 있는 제품을 제공합니다.
            </p>
            ...
            <Link to="/about" className="button">회사 소개 더 보기</Link>
          </div>
          <div className="about-image">
            <img src="/api/placeholder/600/800" alt="자동차 부품 제조 현장" />
          </div>
        </div>
      </div>
    </section>
