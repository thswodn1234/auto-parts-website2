...
import pdtImg from '../assets/images/part1.jpg';
...
export const productsData = [
  {
    ...
    fullDescription:
      '최고급 재질로 제작된 브레이크 패드로, 고온에서도 안정적인 제동력을 유지합니다. 일반 패드 대비 2배 이상의 수명을 자랑하며, 소음과 분진 발생이 적습니다.',
    features: [
      '고온 안정성 향상',
      '마모 저항성 강화',
      '소음 감소 기술 적용',
  ...
  },
  {
    ...
    fullDescription:
      '최신 기술이 적용된 연료 인젝터로, 연료 분사 정밀도를 높여 연비를 향상시키고 출력을 개선합니다. 미세한 분사각 조절로 완전 연소를 돕습니다.',
    features: [
      '정밀한 연료 분사 제어',
      '향상된 분무 패턴',
      '저소음 작동',
  ...
  },
  {
    ...
    fullDescription:
      '차량의 다양한 상태를 정확하게 모니터링하는 센서 패키지입니다. 온도, 압력, 속도 등의 정보를 실시간으로 측정하여 최적의 차량 성능을 유지하는 데 기여합니다.',
    features: [
      '고정밀 측정 기술',
      '빠른 응답 시간',
      '다양한 환경에서 안정적 작동',
